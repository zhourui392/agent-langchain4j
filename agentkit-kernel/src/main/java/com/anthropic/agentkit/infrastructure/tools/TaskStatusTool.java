...
/** Reads the current state, bounded preview, and optional artifact reference of a task. */
public final class TaskStatusTool implements Tool {
    ...
    public TaskStatusTool(BackgroundTaskService tasks) {
        this.tasks = Objects.requireNonNull(tasks, "tasks");
    }

    @Override public String name() { return "TaskStatus"; }
    @Override public String description() { return "Inspect a background task"; }
    ...
    public ToolResult execute(ToolArguments arguments, ExecutionContext context) {
        ...
        return BackgroundTaskToolJson.status(tasks.status(id, context));
    }
}
